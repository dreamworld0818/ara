...
[TC-INST] store word 2
[TC-INST] store word 3
[TC-INST] store word 2
[TC-INST] store word 3
[TC-INST] store word 2
[TC-INST] store word 3
...
TC-INS[TC][BUF_B][SA-RD] bank=0 addr=0 part=0 val=-4
[TC][BUF_A][SA-RD] bank=0 addr=0 part=0 val=-2
[TC][SA][AB] addr=0 A00=0 B00=0
T[TC][DMA][AR HS] ar_valid=1 ar_ready=1 addr=0x000000008001c000 buf=0x4 transpose=0 len=127
[TC][BUF_DIN][DMA-WR] bank=0 addr=0 val=0
[TC][DMA][R0] req_addr=0x000000008001c000 buf=0x4 transpose=0 rdata[31:0]=0x00000000 rdata[7:0]=0x00
] store wo[TC][BUF_DOUT][SA-WR] bank=0 addr=0 val=-155
rd [TC][DMA][AW HS] aw_valid=1 aw_ready=1 addr=0x0000000080020000 len=127
[TC][BUF_DOUT][DMA-RD] dma_addr=0 word0(Dout00)=-155
[TC][BUF_DOUT][DMA-RD] dma_addr=0 word0(Dout00)=-215
2[TC][DMA][W.LAST] 342310 w.last 0 -> 1 (cnt=127 len=127 w_valid=1)
[TC][DMA][W.LAST] 342312 w.last 1 -> 0 (cnt=128 len=127 w_valid=1)
[TC][DMA][AR HS] ar_valid=1 ar_ready=1 addr=0x000000008000c000 buf=0x1 transpose=0 len=31
...
[TC][DMA][W.LAST] 343398 w.last 0 -> 1 (cnt=127 len=127 w_valid=1)
[TC][DMA][W.LAST] 343400 w.last 1 -> 0 (cnt=128 len=127 w_valid=1)
[TC-INST] store word 3
[FA][GEMM2_PxV] MMIO done, polling TC state